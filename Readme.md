...
♨️ Ambil Session Via replit siapa tau bisa saya belum pernah coba 
...
- Upload tepat di folder/file auth_info_baileys.
- Perlu di ingat sesi multi auth bukan session.data.json dan bukan dalam satu file json!

♨️ Ambil Session Via termux
- Kalian bisa ambil di script [here](https://github.com/Jarotr/oscar-v4)
- command?
- git clone https://github.com/Jarotr/oscar-v4
- cd oscar-v4
- node .
...
- Owner Number [Here](https://github.com/Alpiii22/oscar-md-v4-multisession/blob/master/config.js#L1)
- Owner Name [Here](https://github.com/Alpiii22/oscar-md-v4-multisession/blob/master/config.js#L1)
- Bot Name [Here](https://github.com/Alpiii22/oscar-md-v4-multisession/blob/master/config.js#L1)
---------
